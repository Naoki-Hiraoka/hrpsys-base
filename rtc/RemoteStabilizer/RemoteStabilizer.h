...
#include "RemoteStabilizerService_impl.h"
  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedDoubleSeq m_temp, m_surfacetemp;
  RTC::TimedDoubleSeq m_collisioninfo;
  // for debug ouput
  ...
  RTC::InPort<RTC::TimedDoubleSeq> m_acttauIn;
  ...
  RTC::InPort<RTC::TimedDoubleSeq> m_tempIn, m_surfacetempIn;
  RTC::InPort<RTC::TimedDoubleSeq> m_collisioninfoIn;
 ...
 private:
  ...
  std::vector <hrp::Vector3> target_ee_p, rel_ee_pos, act_ee_p, projected_normal, act_force, ref_force, ref_moment;
    std::vector <hrp::Vector3> ref_force_eef, ref_moment_eef, act_force_eef, act_moment_eef, current_force_eef, current_moment_eef, d_foot_pos, d_foot_rpy;
  ...
  std::vector<double> cp_check_margin, cp_check_armmargin, tilt_margin;
